               ...
               child: Container(
                ...
                child: TextWidget(
                              ...
                              size: 12,
                                ...
                                color:select == 3 ? witheColor : blackColor,
                              weight: FontWeight.w600,
                            ),
                         ),
                             decoration: BoxDecoration(
                        color: select == 3 ? primryColor : witheColor,
                         borderRadius: BorderRadius.circular(5),
                         boxShadow:    select!= 3 ? null : [
                BoxShadow(
                  //ifs select change shadow color
                  color: colorShadow,
                  offset: Offset(
               ...
               child: Container(
                ...
                child: TextWidget(
                              ...
                              size: 12,
                                ...
                                color:select == 4 ? witheColor : blackColor,
                              weight: FontWeight.w600,
                            ),
                         ),
                             decoration: BoxDecoration(
                        color: select == 4 ? primryColor : witheColor,
                         borderRadius: BorderRadius.circular(5),
                         boxShadow:    select!= 4 ? null : [
                BoxShadow(
                  //ifs select change shadow color
                  color: colorShadow,
                  offset: Offset(
