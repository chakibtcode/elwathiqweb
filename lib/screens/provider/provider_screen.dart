...
import 'package:elwathiqweb/screens/provider/provider_controller.dart';
          ...
          height:  MediaQuery.of(context).size.height * 0.6,                   
           child :  Row(
            ...
            Flexible(child: Padding(
              ...
              child:CardStatic5(title: 'order', prix: 500, subtitle: 'this day', topTitle: 'All',color: redColor,porsontage: 0.25)
            )),   
                                ],
                              ), 
                                SizedBox(height: defaultPadding),
                                if (Responsive.isMobile(context))
      CardStatic5(title: 'order', prix: 500, subtitle: 'this day', topTitle: 'All',color: redColor, porsontage: 0.25)       ,  
              SizedBox(height: defaultPadding),
