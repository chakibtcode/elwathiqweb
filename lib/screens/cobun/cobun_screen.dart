...
import 'package:elwathiqweb/screens/cobun/cobun_controller.dart';
...
class CobunScreen extends StatelessWidget {
  @override 
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child:  GetBuilder<CobunController>(
                      init: CobunController(),
          ...
          height:  MediaQuery.of(context).size.height * 0.6,                   
           child :  Row(
            ...
            children: [
                ...
                //  CardStatic0X(title: 'fddf', prix: 55515, subtitle: 'dddddvcv',),
                    ...
                    //             children: [
                    //               Flexible(child: CardStatic1(prix: 454546564, title: 'Total profit today', subtitle:'this day',)),
                    //               SizedBox(width: defaultPadding),
                    //               Flexible(child: CardStatic1(prix: 454546564, title: 'Total profit today', subtitle: 'this day',)),
                    //             ],
                    //           ), 
                    SizedBox(height: defaultPadding),
        Row(children: [  Flexible(child: ScrollableTable(user:data.sublist(0,10),),),],)
